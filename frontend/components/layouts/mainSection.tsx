...
export function MainSection() {
    return (
        <>
            <div className=" flex lg:gap-28 justify-center w-full bg-bg-yellow-400 items-center mt-36 xl:px-40  ">
                <div className="flex gap-12 justify-center items-center  w-full ">
                    <div className="px-12 flex   flex-col justify-center items-center md:w-[40rem]  ">
                        <motion.h1
                            ...
                            className="text-5xl text-center font-bold text-blue-950 xl:w-[30rem]  ">Every Home Service One App  Zero Hassles</motion.h1>
                        <motion.p
                            ...
                            className="mt-6 mb-20 text-center ">Book trusted pros for repairs, cleaning, and more — fast, easy, and reliable.</motion.p>
                        <motion.div
